 ...
 */
public final class ActiveDeviceVoltageInjector implements VoltageInjector {
    private final Supplier<SerialConnectionManager> managerSupplier;

    public ActiveDeviceVoltageInjector(Supplier<SerialConnectionManager> managerSupplier) {
