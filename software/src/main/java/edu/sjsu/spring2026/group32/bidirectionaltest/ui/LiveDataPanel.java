...
public final class LiveDataPanel extends JPanel {
    ...
    public void setPrimaryReading(int raw, double volts) {
        rawLabel.setText("Ch1 ADC: " + raw);
        voltageLabel.setText(String.format("Ch1: %.3f V", volts));
    }

    public void setSecondaryReading(int raw, double volts) {
    ...
    public void setModeInjecting(int channel) {
    ...
    public void appendChannelLog(String text, int channel) {
