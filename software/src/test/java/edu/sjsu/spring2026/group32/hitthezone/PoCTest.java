...
class PoCTest {
    ...
    void setUp() {
        ...
        game = new HitTheZoneGame(players) {
            @Override
    ...
    void testRightWallBounce() {
        ...
        game.ballX = HitTheZoneGame.WIDTH - HitTheZoneGame.BALL_DIAM;
        game.direction = HitTheZoneGame.SPEED;
    ...
    void testBallMovesWhenNotPaused() {
        ...
        game.ballX = HitTheZoneGame.START_X;
        game.direction = HitTheZoneGame.SPEED;
    ...
    void testZoneEntryArmsCanScore() {
        ...
        game.ballX = HitTheZoneGame.ZONE_START - HitTheZoneGame.BALL_DIAM / 2 - HitTheZoneGame.SPEED;
        game.direction = HitTheZoneGame.SPEED;
        game.inZone = false;
    ...
    void testZoneExitClearsCanScore() {
        ...
        game.ballX = HitTheZoneGame.ZONE_START + HitTheZoneGame.ZONE_WIDTH;
        game.inZone = true;
    ...
    void testProcessScoreIncrementsHitsAndAttempts() {
        ...
        game.ballX = HitTheZoneGame.ZONE_START - HitTheZoneGame.BALL_DIAM / 2;
        game.canScore[0] = true;
    ...
    void testMultipleScoresPerZonePass() {
        ...
        game.ballX = HitTheZoneGame.ZONE_START - (HitTheZoneGame.BALL_DIAM / 2); // center lands on ZONE_START
        game.canScore[0] = true; 
        game.inZone = true; 
    ...
    void testResetFunctionality() {
        ...
        assertEquals(HitTheZoneGame.START_X, game.ballX, "ballX should return to START_X after resetting");
    ...
    void testOnTickDispatchesReset() {
        ...
        game = new HitTheZoneGame(List.of(mockPlayer)) {
        ...
        assertEquals(HitTheZoneGame.START_X, game.ballX, "resetGame() should return ball to START_X");
    }
    ...
    void setZoneWidthThrowsIllegalArgumentOnInvalidValue() {
        ...
        assertThrows(IllegalArgumentException.class, () -> game.setZoneWidth(HitTheZoneGame.WIDTH));
    }
    // ──────────────────────────────────────────────────────────────────────────
    ...
    void createDefaultPlayersReturnsFourPlayersWithoutHardware() {
        var players = HitTheZoneGame.createDefaultPlayers(null);
    ...
    void createDefaultPlayersIncludesHardwareAIWithConnectedManager() {
        ...
        var players = HitTheZoneGame.createDefaultPlayers(mockManager);
    ...
    void zoneStartReturnsExpectedCenter() {
        int expected = (HitTheZoneGame.WIDTH - game.zoneWidth) / 2;
    ...
    void zoneStartUpdatesAfterWidthChange() {
        game.setZoneWidth(200);
        int expected = (HitTheZoneGame.WIDTH - 200) / 2;
